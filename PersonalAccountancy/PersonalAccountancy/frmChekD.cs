...
{
    public partial class frmChekD : Office2007Form
    {
        public frmChekD()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "insert into CheckD(ShH,NameHesab,Mablagh,NameSh,Tarikh,SarResid)values(@a,@b,@c,@d,@e,@f)";
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            MessageBox.Show("ثبت چک دریافتی انجام شد");
            //**************************************
            txtSh.Text = "";
            txtName.Text = "";
            txtMablagh.Text = "";
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "select * from CheckD where id=@s";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            cmd.Parameters.Clear();
            cmd.Connection = con;
            cmd.CommandText = "Delete from CheckD where id=" + txtCode.Text;
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            cmd.Parameters.Clear();
            cmd.Connection = con;
            cmd.CommandText = "Update CheckD set ShH='" + txtSh.Text + "',NameHesab='" + txtName.Text + "',Mablagh='" + txtMablagh.Text + "',NameSh='" + txtNameSh.Text + "',Tarikh='" + mskTarikh.Text + "',SarResid='" + mskSarResid.Text + "' where id=" + txtCode.Text;
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            MessageBox.Show("ویرایش چک دریافتی انجام شد");
            //**************************************
            txtSh.Text = "";
            txtName.Text = "";
            txtMablagh.Text = "";
